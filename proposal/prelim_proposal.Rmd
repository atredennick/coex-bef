...
Such separation limits our ability to predict how ecosystems might respond to projected increases in environmental variability.

How will ecosystem stability respond to increasing environmental variability?
An intuitive prediction is that ecosystem functioning will become less stable as environmental variability increases.
Such a prediction stems from two established facts.
...
This prediction still assumes that species' abundances will fluctuate more as environmental variability increases, but such increases in variability are compensated for by species additions.
Species additions occur because species coexistence is promoted by environmental variability, so-call fluctuation-dependent species coexistence.
...
\noindent{}\textbf{2. Advancing Theory Connecting Coexistence and Ecosystem Stability.}
New theory .... storage effect only .... annual plant specific

\noindent{}\textbf{3. Empirically Testing New Theory.}
